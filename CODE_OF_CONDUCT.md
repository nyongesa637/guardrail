...
participation in the guardrail project a harassment-free
...
repository, issues, PRs, discussions — and also applies when an
...
address in [`SECURITY.md`](./SECURITY.md) (use the same private
...
### 1. Correction
**Community Impact:** Inappropriate language or unprofessional
behaviour.
**Consequence:** Private written warning; public apology may be
requested.

### 2. Warning
**Community Impact:** A violation through a single incident or series
of actions.
**Consequence:** Warning, no interaction with the people involved
for a specified period.

### 3. Temporary ban
**Community Impact:** A serious violation, including sustained
inappropriate behaviour.
**Consequence:** Temporary ban from any interaction with the
community.
